...
class FormBuilderController extends BaseController
{
    ...
    public function loadFormBuilders(Request $request)
    {
        ...
        return $this->render('@_uvdesk_extension_uvdesk_form_builder\FormBuilders\formBuilderListConfigurations.html.twig', []);
    }
    ...
    public function createFormBuilderConfiguration(Request $request)
    {
        ...
        return $this->render('@_uvdesk_extension_uvdesk_form_builder\FormBuilders\manageConfigurations.html.twig', [
                'formbuilder' => [],
    ...
    public function previewForm($id, Request $request, FileUploadService $fileUploadService , CustomFieldsService $customFieldsService = null)
    {
        ...
        return $this->render('@_uvdesk_extension_uvdesk_form_builder\FormBuilders\previewForm.html.twig', [
            'formbuilder' => $data,
            'customFields' => $customFieldsArray,
        ]);
    }
